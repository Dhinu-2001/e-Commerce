...
urlpatterns = [
    ...
    path('product_detail/<int:product_id>/',views.product_detail.as_view(), name='product_detail'),
    path('stock_update/<int:product_id>',views.stock_update.as_view(),name='stock_update'),
    path('add_new_variant/<int:product_id>/',views.add_new_variant.as_view(),name='add_new_variant'),
